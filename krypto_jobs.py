...
st.sidebar.write("Account Balance: ", ether_balance)
...
total_wage = candidate_hourly_rate * hours

# @TODO
# Write the `wage` calculation to the Streamlit sidebar
st.sidebar.write(f"Total Wage: ${total_wage:.2f}")
...
if st.sidebar.button("Send Transaction"):
    # Use the previously calculated `total_wage` as `wage`
    wage = total_wage
